...
import com.aliengui.component.dimension.WindowRelativeDimensionComponent;
import com.aliengui.event.key.KeyEvent;
import com.aliengui.event.key.KeyListener;
import com.aliengui.event.mouse.MouseEvent;
...
public class WindowView extends View {
    ...
    protected com.aliengui.api.view.window.Window window;
    ...
    protected WindowView(Builder<?> builder) {
        ...
        if (window == null) //used if the user creates a WindowView object (the Window object will be created automatically)
            window = new com.aliengui.api.view.window.Window.Builder<>().windowView(this).build();
    ...
    public com.aliengui.api.view.window.Window getWindow() { return window; }
